...
router.post('/analyze-images', upload.array('images', 3), async (req, res) => {
  ...
  try {
    ...
    const content = [{ type: "text", text: "this is a game of finding which fashion designer are you based on your ootd. I am going to upload 1 to 3 images of my outfit. Do the following based on the picture inputs. First, output a famous fashion designer that best matches my style. Then, give one sentence describing of the designer's style \"desc_sentence1\" and another insightful sentence of the designer's era and history as \"desc_sentence2\", within 180-200 characters in total. After this, write a sentence that describes/compliment my outfit, relating it to the fashion designer's style, as \"compliment\" within to 70-90 characters. Use fashion magazine language that also suits my outfit style. Finally, pick two styles tags out of this list that best matches my outfit 'casual, edgy, romantic, athleisure, minimalist, sophisticated, bohemian, street, glam'. Output in json format, split into 'designer', 'desc_sentence1/2', 'compliment', and 'tags'." }];
